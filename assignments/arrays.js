...
console.log(car33.car_year, car33.car_make, car33.car_model);
...
// carModels.sort()
// }
carModels.push(inventory[i].car_model) //When referencing array contents, call index[i] like so <---
}
carModels.sort()
...
let carYearsSorted = [];
carYearsSorted.push(carYears.sort)
